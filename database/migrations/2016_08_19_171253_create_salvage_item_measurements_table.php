...
class CreateSalvageItemMeasurementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('salvage_item_measurements', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('salvage_item_measurements');
    }
}

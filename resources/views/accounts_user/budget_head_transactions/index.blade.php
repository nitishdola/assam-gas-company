				...
				<table class="table table-striped table-bordered table-advance table-hover">
				    ...
				    <tbody>
				        ...
				        <tr>
				            ...
				            <td> <a onclick="return confirm('Are you sure you want to delete this Transaction ?');" href="{{ route('budget_head_transaction.disable', Crypt::encrypt($v->id) ) }}" title="Remove Transaction"><i class="fa fa-trash-o fa-fw"></i>Remove</a> </td>
				        </tr>
				        @endforeach
				    </tbody>
				</table>

<div id="items_block" class="col-xs-12" style="margin-bottom:15px;">
	{{ dump($requisition_items)}}
	@foreach($requisition_items as $v)
	<div style="border:1px solid #D9D6D6; padding:8px; background:#E7E3E3; margin:10px 0">
		<div class="form-group {{ $errors->has('item_measurement_id') ? 'has-error' : ''}}">
		  ...
		  <div class="col-md-9">
		    {!! Form::select('item_measurement_id[]', $item_measurements, $v->item_measurement_id, ['class' => 'required form-control col-md-12 item_measurement', 'id' => 'item_measurement_id', 'autocomplete' => 'off', 'required' => 'true']) !!}
		  </div>
		...
		<div class="form-group {{ $errors->has('store_description') ? 'has-error' : ''}}">
		  ...
		  <div class="col-md-9">
		    {!! Form::textarea('store_description[]', $v->store_description, ['class' => 'form-control required', 'id' => 'store_description', 'rows' => 2, 'placeholder' => 'Description of Stores', 'autocomplete' => 'off', 'required' => 'true']) !!}
		  </div>
		...
		<div class="form-group {{ $errors->has('measurement_unit_id') ? 'has-error' : ''}}">
		  ...
		  <div class="col-md-9">
		    {!! Form::select('measurement_unit_id[]', $units, $v->measurement_unit_id, ['class' => 'required form-control col-md-12', 'id' => 'measurement_unit_id', 'autocomplete' => 'off', 'required' => 'true']) !!}
		  </div>
		...
		<div class="form-group {{ $errors->has('quantity_demanded') ? 'has-error' : ''}}">
		  ...
		  <div class="col-md-3">
		    {!! Form::number('quantity_demanded[]', $v->quantity_demanded, ['class' => 'form-control required', 'id' => 'quantity_demanded', 'step' => '0.01', 'placeholder' => 'Quantity Demanded', 'autocomplete' => 'off', 'required' => 'true']) !!}
		  </div>
		...
		<div class="form-group {{ $errors->has('remarks') ? 'has-error' : ''}}">
		  ...
		  <div class="col-md-9">
		    {!! Form::textarea('remarks[]', $v->remarks, ['class' => 'form-control required', 'id' => 'remarks', 'rows' => 2, 'placeholder' => 'Remarks if any', 'autocomplete' => 'off',]) !!}
		  </div>

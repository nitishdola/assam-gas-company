<table class="table" id="req_table">
  <thead>
    <tr>
      ...
      <th class="col-md-3">Store Description</th>
  ...
  <tbody>
    <tr class="tr_clone">
      ...
      <td class="col-md-3">{!! Form::text('store_description[]', null, ['class' => 'form-control required', 'id' => 'store_description',  'placeholder' => 'Description of Stores', 'autocomplete' => 'off', 'required' => 'true']) !!}</td>
      ...
      <td class="col-md-3">{!! Form::text('remarks[]', null, ['class' => 'form-control required', 'id' => 'remarks',  'placeholder' => 'Remarks if any', 'autocomplete' => 'off',]) !!}</td>
    </tr>
  </tbody>
</table>

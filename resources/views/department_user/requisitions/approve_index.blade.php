			...
			<table class="table table-striped table-bordered table-advance table-hover">
			    ...
			    <tbody>
			        ...
			        <tr @if(!$v->status) class="danger" @endif>
			            ...
			            @if($v->hod)  
						<a onclick="return confirm('Are you sure you want to delete this item ?');"  style="color:red" href="#" title="Remove Item"><i class="fa fa-thumbs-up-o fa-fw"></i>Approved by HOD</a>
						@else
						
						 <a onclick="return confirm('Are you sure you want to approve this requisition ?');"  style="color:red" href="{{ route('requisition.approve', Crypt::encrypt($v->id) ) }}" title="Remove Item"><i class="fa fa-check-square-o fa-fw"></i>Approve</a>
						@endif
						</td>
			        </tr>
			        @endforeach

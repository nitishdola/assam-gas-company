<?php
$name=$vendor_code = $vendor_code = $vendor_mobile = null;
if(isset($_GET['vendor_code'])) {
  $vendor_code = $_GET['vendor_code'];
}
if(isset($_GET['name'])) {
  $vendor_code = $_GET['name'];
}
if(isset($_GET['vendor_phone'])) {
  $vendor_code = $_GET['vendor_phone'];
}
if(isset($_GET['vendor_mobile'])) {
  $vendor_code = $_GET['vendor_mobile'];
}
...
<div class="col-lg-6">
  <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-9">
      {!! Form::text('name', $name, ['class' => 'form-control required', 'id' => 'name', 'placeholder' => 'Vendor Name', 'autocomplete' => 'off',]) !!}
    </div>
  ...
  <div class="form-group {{ $errors->has('vendor_code') ? 'has-error' : ''}}">
    ...
    <div class="col-md-9">
      {!! Form::text('vendor_code', $vendor_code, ['class' => 'form-control required', 'id' => 'vendor_code', 'placeholder' => 'Vendor Code', 'autocomplete' => 'off', ]) !!}
    </div>
...
<div class="col-lg-6">
  <div class="form-group {{ $errors->has('vendor_phone') ? 'has-error' : ''}}">
    ...
    <div class="col-md-9">
      {!! Form::tel('vendor_phone',$vendor_code , ['class' => 'form-control ', 'id' => 'vendor_phone', 'placeholder' => 'Supplier/Vendor Phone', 'autocomplete' => 'off']) !!}
    </div>
  ...
  <div class="form-group {{ $errors->has('vendor_mobile') ? 'has-error' : ''}}">
    ...
    <div class="col-md-9">
      {!! Form::number('vendor_mobile', $vendor_mobile, ['class' => 'form-control ', 'id' => 'vendor_mobile', 'placeholder' => 'Vendor Mobile', 'autocomplete' => 'off',]) !!}
    </div>
